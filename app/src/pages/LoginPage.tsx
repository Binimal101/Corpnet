      ...
      >
        <div className="glass rounded-2xl border border-border/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            >
              <div className="w-20 h-20 mx-auto relative">
                ...
                />
                <div className="absolute inset-4 rounded-full bg-gradient-to-br from-mosaic-purple via-mosaic-teal to-mosaic-coral flex items-center justify-center">
            ...
            <p className="text-sm text-muted-foreground">
              Sign in to explore your knowledge base
            </p>
          </div>
          ...
          <Button
            ...
            className="w-full h-12 text-base gap-3 bg-gradient-to-r from-mosaic-purple to-mosaic-teal hover:opacity-90 transition-opacity"
          >
          ...
          <p className="text-center text-sm text-muted-foreground mt-4">
            ...
            <Link to="/signup" className="text-mosaic-purple hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </div>
